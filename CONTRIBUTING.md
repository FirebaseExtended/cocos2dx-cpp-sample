# Contributing to the Firebase C++ Cocos Samples

We'd love for you to contribute to our source code and to make the Firebase C++
Cococs Samples project even better than they are today! Here are the guidelines
...
As contributors and maintainers of the Firebase C++ Cococs Samples project, we
...
of the Firebase C++ Cococs Samples project may take action, removing issues,
comments, and PRs or blocking accounts as deemed appropriate.

## <a name="question"></a> Got a Question or Problem?

If you have questions about how to use the Firebase C++ Cococs Samples, please
...
* Search [GitHub](https://github.com/firebase/cocos2dx-cpp-sample/pulls) for an
...
* In GitHub, send a pull request to `firebase/cocos2dx-cpp-sample:master`.
...
[github]: https://github.com/firebase/cocos2dx-cpp-sample
